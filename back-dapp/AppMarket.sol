...
contract AppMarket is Ownable {
    ...
    function makeSell(uint256 _tokenId, uint256 _price) public {
        tokenContract.transfer(address(this), _tokenId); // transfer token to this contract (keep until someone buy)
